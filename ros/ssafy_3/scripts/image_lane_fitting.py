...
class IMGParser:
    def __init__(self, pkg_name = 'ssafy_3'):
        ...
        self.lower_ylane = np.array([0, 90, 100])# ([0,60,100])
        self.upper_ylane = np.array([40, 175, 255])# ([40,175,255])

        self.crop_pts = np.array([[[0, 480], [220, 240], [420, 240], [640, 480]]])
        ...
        curve_learner = CURVEFit(order=3, alpha=10, lane_width=3, y_margin=0.5, x_range=40, dx=0.2, min_pts=80)
